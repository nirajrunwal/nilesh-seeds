...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF2aHJ0YnB0cGpjcWx5eWZwdGJvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MDgyMTU2MCwiZXhwIjoyMDg2Mzk3NTYwfQ.rV1e556lmVBDoHkjl302G_9lQ5oObwoDiv2Qdk8c-jE';
  ...
  `;
    ...
    try {
        ...
        if (error) {
            ...
            await supabase.from('farmers').select('*').limit(1);
            ...
            await supabase.from('prescriptions').select('*').limit(1);
        ...
        console.log('\n🎉 Backend is ready!');
        console.log('📧 Default admin: admin@nileshseeds.com');
        console.log('🔑 Default password: admin123');

    } catch (err) {
        console.log('⚠️  Note: Tables may already exist or need manual creation');
        console.log('📝 Please open Supabase dashboard > SQL Editor');
        console.log('📋 Copy and paste the SQL from: supabase/init.sql');
